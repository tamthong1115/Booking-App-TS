            ...
            <div className={cx("info-user")}>
                ...
                <div className={cx("inner")}>
                    <button className={cx("user-avatar")}>
                        <img
                            className={cx("avatar")}
                            src="https://th.bing.com/th/id/OIF.4WFOQwlZksza8h7Qdotn5Q?w=131&h=150&c=7&r=0&o=5&dpr=1.3&pid=1.7"
                            alt="Avatar"
                        />
                    </button>
                </div>
            ...
            <div>
                ...
                <div className={cx("info")}>
                    ...
                    {isEditing.birthday ? (
                        ...
                        <p className={cx("description")}>{currentUser.birthday?.toString() || "Add your birthday"}</p>
                    )}
                    <button
                        className={cx("info-btn")}
                        onClick={() => {
